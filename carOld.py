...
class Car:
    ...
    def escape_stuck(self):
        # Reverse
        self.motor.set_motor_model(-1200, -1200, -1200, -1200)
        time.sleep(0.4)

        # Hard turn (randomized direction is even better)
        self.motor.set_motor_model(1500, 1500, -1500, -1500)
        time.sleep(0.35)
    ...
    def scan_and_avoid(self):
        ...
        # reuse existing avoidance logic
